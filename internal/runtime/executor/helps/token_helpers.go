...
// ---------------------------------------------------------------------------
// Claude-specific token counting (local addition, not in upstream)
// ---------------------------------------------------------------------------
...
// CollectOpenAIContent is the exported version of collectOpenAIContent for
// use by external packages.
func CollectOpenAIContent(content gjson.Result, segments *[]string) {
